...
export default function ConsultaCTA({ codigo, nombre, pagina }) {
  const texto = `Hola, consulto por el producto ${codigo} — ${nombre || ''} (Catálogo Logbelts${pagina ? `, pág. ${pagina}` : ''})`;
  return (
    <a
      className="cta"
      ...
      target="_blank"
      rel="noreferrer"
      onClick={() => logEvento({ tipo: 'consulta', codigo })}
    >
